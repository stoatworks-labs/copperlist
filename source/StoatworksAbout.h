/*
 * Stoatworks Labs - About window data for Copperlist.
 *
 * PROVISIONAL, hand-written in the shape stoatworks-backend/scripts/sync-about.py
 * generates. Copperlist is not yet registered in the website's projects.json, so
 * the sync cannot produce this file; once it is, `sync-about.py --only
 * copperlist --apply` overwrites this with the generated copy. The facts below
...
namespace stoatworks::about
{
    ...
    inline constexpr auto repo = "https://github.com/stoatworks-labs/copperlist";
